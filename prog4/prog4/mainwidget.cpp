...
int MainWidget::on_label_Click(MovableLabel *lbl)
{
    ...
    if(Move == false){
        ...
        return 0;
            ...
            //neither is checked tell user

            /* My other logic that should work but was not working. forcing me to use
             *a hated global variable that you approved prior.
             *
 if(ui->btnDelete->isChecked()){
    delete lbl;
    return 0;
        }else{
        ...
        return 1;
            ...
            //neither is checked output uh-oh
 */
